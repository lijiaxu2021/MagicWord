...
!\[Version]\(https\://img.shields.io/badge/version-0.0.21-blue.svg null)
!\[Platform]\(https\://img.shields.io/badge/platform-Android%20%7C%20Cloudflare%20%7C%20GitHub-orange.svg null)
...
1. **直接下载**: [MagicWord.apk](https://mag.upxuu.com/mw.apk)
2. 打开 `easyword` 目录。
3. 配置 `local.properties` (可选 API Key)。
